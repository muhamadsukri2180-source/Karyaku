...
<head>
    ...
    <title>Karyaku - Detail Pembayaran Membership</title>
    <!-- Tailwind CSS -->
        ...
        <main class="flex-1 flex flex-col min-w-0 w-full">
            <header class="bg-white/70 backdrop-blur-xl border-b border-sky-200 px-6 py-4 flex items-center justify-between sticky top-0 z-30 shadow-sm">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-xl sm:text-2xl font-extrabold tracking-tight font-display text-slate-900">Pemeriksaan Pembayaran</h2>
                        <p class="text-[11px] sm:text-xs text-slate-600 font-semibold mt-0.5">Validasi bukti resi transfer dan kesesuaian nominal tagihan.</p>
                    </div>
                </div>
