                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    <div class="bg-gradient-to-br from-blue-50 via-white to-blue-100/60 border-l-4 border-blue-500 border-y border-r border-blue-200 p-5 rounded-2xl card-hover relative overflow-hidden group shadow-sm">
                        <div class="flex justify-between items-start mb-2 relative z-10">
                            <div><span class="text-[11px] font-bold text-blue-900 uppercase tracking-wider">Total Pengguna</span><div class="text-3xl font-black text-slate-900 mt-1">1,205</div></div>
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 via-white to-emerald-100/60 border-l-4 border-emerald-500 border-y border-r border-emerald-200 p-5 rounded-2xl card-hover relative overflow-hidden group shadow-sm">
                        <div class="flex justify-between items-start mb-2 relative z-10">
                            <div><span class="text-[11px] font-bold text-emerald-900 uppercase tracking-wider">Kreator Aktif</span><div class="text-3xl font-black text-slate-900 mt-1">845</div></div>
                    ...
                    <div class="bg-gradient-to-br from-amber-50 via-white to-amber-100/60 border-l-4 border-amber-500 border-y border-r border-amber-200 p-5 rounded-2xl card-hover relative overflow-hidden group shadow-sm">
                        <div class="flex justify-between items-start mb-2 relative z-10">
                            <div><span class="text-[11px] font-bold text-amber-900 uppercase tracking-wider">Pengguna Baru</span><div class="text-3xl font-black text-slate-900 mt-1">128</div></div>
                    ...
                    <div class="bg-gradient-to-br from-red-50 via-white to-red-100/60 border-l-4 border-red-500 border-y border-r border-red-200 p-5 rounded-2xl card-hover relative overflow-hidden group shadow-sm">
                        <div class="flex justify-between items-start mb-2 relative z-10">
                            <div><span class="text-[11px] font-bold text-red-900 uppercase tracking-wider">Akun Diblokir</span><div class="text-3xl font-black text-slate-900 mt-1">14</div></div>
                ...
                <div class="bg-gradient-to-b from-white to-sky-50/30 border border-sky-200 rounded-2xl shadow-sm overflow-hidden">
                    <div class="p-5 border-b border-sky-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/50 backdrop-blur-sm">
                        <div class="relative w-full sm:w-72">
                            ...
                            <input type="text" placeholder="Cari nama atau email..." class="pl-8 pr-4 py-2 w-full bg-white border border-sky-200 rounded-xl text-xs font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-sky-500/30 focus:border-sky-500 transition-all shadow-sm">
                        </div>
                        <!-- Tombol Tambah di Kanan Atas -->
                        <button onclick="alert('Buka Modal Tambah Pengguna')" class="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white text-xs font-bold rounded-xl shadow-md shadow-sky-500/30 transition-all flex items-center justify-center gap-2 w-full sm:w-auto">
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="text-sm divide-y divide-sky-100/70">
                                ...
                                <tr class="hover:bg-sky-50/50 transition-colors bg-white">
                                    <td class="py-3 px-6">
                                        <div class="flex items-center gap-3">
                                            <div class="w-9 h-9 rounded-full bg-gradient-to-tr from-sky-500 to-blue-600 text-white flex items-center justify-center font-bold text-xs shadow-sm">AF</div>
                                            <div>
                                                <p class="font-bold text-slate-800 text-xs">Ahmad Fauzi</p>
                                                <p class="text-[10px] text-slate-500 font-medium">ahmad.f@example.com</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6">
                                        <span class="text-[11px] font-bold text-indigo-700 bg-indigo-50 border border-indigo-200 px-2 py-1 rounded-md shadow-sm">Kreator</span>
                                    </td>
                                    <td class="py-3 px-6"><p class="text-xs font-semibold text-slate-700">01 Jan 2026</p></td>
                                    <td class="py-3 px-6"><span class="text-[10px] font-bold text-emerald-700 bg-emerald-100 border border-emerald-200 px-2.5 py-1 rounded-md flex items-center w-max gap-1.5"><i class="fa-solid fa-circle text-[6px]"></i> Aktif</span></td>
                                    <td class="py-3 px-6">
                                        <div class="flex items-center justify-center gap-2">
                                            <button onclick="alert('Edit Pengguna')" class="px-2.5 py-1.5 rounded-lg bg-blue-50 text-blue-600 border border-blue-200 hover:bg-blue-600 hover:text-white transition-all text-xs font-bold shadow-sm" title="Edit"><i class="fa-solid fa-pen-to-square"></i> Edit</button>
                                            <button onclick="alert('Hapus Pengguna')" class="px-2.5 py-1.5 rounded-lg bg-red-50 text-red-600 border border-red-200 hover:bg-red-600 hover:text-white transition-all text-xs font-bold shadow-sm" title="Hapus"><i class="fa-solid fa-trash"></i> Hapus</button>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr class="hover:bg-sky-50/50 transition-colors bg-white">
                                    <td class="py-3 px-6">
                                        <div class="flex items-center gap-3">
                                            <div class="w-9 h-9 rounded-full bg-gradient-to-tr from-purple-500 to-pink-600 text-white flex items-center justify-center font-bold text-xs shadow-sm">SA</div>
                                            <div>
                                                <p class="font-bold text-slate-800 text-xs">Siti Aisyah</p>
                                                <p class="text-[10px] text-slate-500 font-medium">siti.a@example.com</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6">
                                        <span class="text-[11px] font-bold text-slate-600 bg-slate-100 border border-slate-200 px-2 py-1 rounded-md shadow-sm">Pembeli</span>
                                    </td>
                                    <td class="py-3 px-6"><p class="text-xs font-semibold text-slate-700">15 Feb 2026</p></td>
                                    <td class="py-3 px-6"><span class="text-[10px] font-bold text-emerald-700 bg-emerald-100 border border-emerald-200 px-2.5 py-1 rounded-md flex items-center w-max gap-1.5"><i class="fa-solid fa-circle text-[6px]"></i> Aktif</span></td>
                                    <td class="py-3 px-6">
                                        <div class="flex items-center justify-center gap-2">
                                            <button onclick="alert('Edit Pengguna')" class="px-2.5 py-1.5 rounded-lg bg-blue-50 text-blue-600 border border-blue-200 hover:bg-blue-600 hover:text-white transition-all text-xs font-bold shadow-sm" title="Edit"><i class="fa-solid fa-pen-to-square"></i> Edit</button>
