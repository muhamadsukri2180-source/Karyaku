    ...
    <div class="flex min-h-screen relative">
        ...
        <aside id="sidebar" class="w-[260px] bg-gradient-to-b from-skyDeep via-skyHover to-sky text-white flex flex-col shrink-0 border-r border-sky-400/20 shadow-2xl fixed lg:sticky top-0 h-screen z-50 closed lg:translate-x-0">
            ...
            <nav class="flex-1 px-4 space-y-1.5 text-[13px] font-semibold text-sky-100 overflow-y-auto pt-4 pb-4">
                ...
                <div>
                    <!-- Menu Katalog & Kategori Terbuka dan Aktif -->
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    <div class="bg-gradient-to-br from-indigo-50 via-white to-indigo-100/60 border-l-4 border-indigo-500 border-y border-r border-indigo-200 p-5 rounded-2xl card-hover shadow-sm">
                        <div class="flex justify-between items-start mb-2">
                            <div><span class="text-[11px] font-bold text-indigo-900 uppercase tracking-wider">Total Kategori</span><div class="text-3xl font-black text-slate-900 mt-1">15</div></div>
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 via-white to-emerald-100/60 border-l-4 border-emerald-500 border-y border-r border-emerald-200 p-5 rounded-2xl card-hover shadow-sm">
                        <div class="flex justify-between items-start mb-2">
                            <div><span class="text-[11px] font-bold text-emerald-900 uppercase tracking-wider">Kategori Terpopuler</span><div class="text-xl font-black text-slate-900 mt-2">Website & IT</div></div>
                    ...
                    <div class="bg-gradient-to-br from-red-50 via-white to-red-100/60 border-l-4 border-red-500 border-y border-r border-red-200 p-5 rounded-2xl card-hover shadow-sm">
                        <div class="flex justify-between items-start mb-2">
                            <div><span class="text-[11px] font-bold text-red-900 uppercase tracking-wider">Kategori Nonaktif</span><div class="text-3xl font-black text-slate-900 mt-1">2</div></div>
                ...
                <div class="bg-gradient-to-b from-white to-sky-50/30 border border-sky-200 rounded-2xl shadow-sm overflow-hidden">
                    <div class="p-5 border-b border-sky-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/50 backdrop-blur-sm">
                        <div class="relative w-full sm:w-72">
                            ...
                            <input type="text" placeholder="Cari nama kategori..." class="pl-8 pr-4 py-2 w-full bg-white border border-sky-200 rounded-xl text-xs font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-sky-500/30 focus:border-sky-500 transition-all shadow-sm">
                        </div>
                        <!-- Tombol Tambah Kategori -->
                        <button onclick="alert('Buka Modal Tambah Kategori')" class="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white text-xs font-bold rounded-xl shadow-md shadow-sky-500/30 transition-all flex items-center justify-center gap-2 w-full sm:w-auto">
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="text-sm divide-y divide-sky-100/70">
                                ...
                                <tr class="hover:bg-sky-50/50 transition-colors bg-white">
                                    <td class="py-3 px-6">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 rounded-xl bg-sky-100 text-sky-600 flex items-center justify-center text-lg border border-sky-200 shadow-sm"><i class="fa-solid fa-laptop-code"></i></div>
                                            <div>
                                                <p class="font-bold text-slate-800 text-xs">Pembuatan Website & IT</p>
                                                <p class="text-[10px] text-slate-500 font-medium">Slug: website-it</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6"><p class="text-[11px] text-slate-600 w-48 truncate">Layanan seputar web development, aplikasi, dan server.</p></td>
                                    <td class="py-3 px-6 text-xs font-bold text-sky-700">1,240 Layanan</td>
                                    <td class="py-3 px-6">
                                    ...
                                    <td class="py-3 px-6">
                                        <div class="flex items-center justify-center gap-2">
                                            <button onclick="alert('Edit Kategori')" class="px-2.5 py-1.5 rounded-lg bg-blue-50 text-blue-600 border border-blue-200 hover:bg-blue-600 hover:text-white transition-all text-xs font-bold shadow-sm" title="Edit"><i class="fa-solid fa-pen-to-square"></i> Edit</button>
                                            <button onclick="alert('Hapus Kategori')" class="px-2.5 py-1.5 rounded-lg bg-red-50 text-red-600 border border-red-200 hover:bg-red-600 hover:text-white transition-all text-xs font-bold shadow-sm" title="Hapus"><i class="fa-solid fa-trash"></i> Hapus</button>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr class="hover:bg-sky-50/50 transition-colors bg-white">
                                    <td class="py-3 px-6">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 rounded-xl bg-emerald-100 text-emerald-600 flex items-center justify-center text-lg border border-emerald-200 shadow-sm"><i class="fa-solid fa-palette"></i></div>
                                            <div>
                                                <p class="font-bold text-slate-800 text-xs">Desain Grafis & Logo</p>
                                                <p class="text-[10px] text-slate-500 font-medium">Slug: desain-grafis</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6"><p class="text-[11px] text-slate-600 w-48 truncate">Jasa desain visual, logo, identitas brand, dan ilustrasi.</p></td>
                                    <td class="py-3 px-6 text-xs font-bold text-sky-700">850 Layanan</td>
                                    <td class="py-3 px-6">
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[10px] font-bold bg-emerald-100 text-emerald-800 border border-emerald-200">
                                            Aktif
                                        </span>
