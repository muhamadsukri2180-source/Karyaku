...
<div class="seller-page-head mb-4">
    <h4 class="mb-1"><i class="bi bi-shield-exclamation text-danger me-2"></i>Peringatan & Teguran Akun</h4>
    <p class="small mb-0">Daftar catatan teguran resmi dari Tim Verifikator / Admin terkait aktivitas atau laporan yang masuk terhadap akun penjual Anda.</p>
</div>
